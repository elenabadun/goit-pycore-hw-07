...
Сама реалізація функції add*contact може виглядати наступним чином:
@input_error
...
Наша функція add*contact має два призначення - додавання нового контакту або оновлення телефону для контакту, що вже існує в адресній книзі.
